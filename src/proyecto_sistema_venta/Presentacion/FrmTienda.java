...
public class FrmTienda extends javax.swing.JInternalFrame {
    ...
    private final TiendaNegocio CONTROL;
    ...
    public FrmTienda() {
        initComponents();
        this.CONTROL = new TiendaNegocio();
        this.accion = "guardar";
        this.listar("");
    ...
    private void BtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        if (this.accion.equals("guardar")) {
            resp = this.CONTROL.insertar(TxtCodigo.getText(), TxtNombre.getText(), TxtDireccion.getText(), TxtTelefono.getText());
            if (resp.equals("OK")) {
                this.limpiar();
                this.listar("");
                JOptionPane.showMessageDialog(this, "Tienda registrada correctamente", "Sistema", JOptionPane.INFORMATION_MESSAGE);
            ...
            if (resp.equals("OK")) {
                this.limpiar();
                this.listar("");
                JOptionPane.showMessageDialog(this, "Tienda actualizada correctamente", "Sistema", JOptionPane.INFORMATION_MESSAGE);
                TabGeneral.setSelectedIndex(0);
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {
        if (TblDatos.getSelectedRowCount() == 1) {
            ...
            String direccion = String.valueOf(TblDatos.getValueAt(TblDatos.getSelectedRow(), 3));
            String telefono = String.valueOf(TblDatos.getValueAt(TblDatos.getSelectedRow(), 4));
            String estado = String.valueOf(TblDatos.getValueAt(TblDatos.getSelectedRow(), 5));
    ...
    private void BtnAnularActionPerformed(java.awt.event.ActionEvent evt) {                                          
        if (TblDatos.getSelectedRowCount() == 1) {
            ...
            if (JOptionPane.showConfirmDialog(this, "¿Desea cambiar el estado de la tienda " + nombre + "?", "Sistema", JOptionPane.YES_NO_OPTION) == 0) {
                String resp;
